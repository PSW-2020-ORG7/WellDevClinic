...
namespace WellDevCore.Migrations
{
    ...
    [Migration("20210109145853_Microservice_test")]
    partial class Microservice_test
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WellDevCore.Model.Dto.EquipmentDTO", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WellDevCore.Model.Dto.EquipmentDTO", b =>
                {
                    b.HasOne("Model.Director.Equipment", "Equipment")
                        .WithMany()
                        .HasForeignKey("EquipmentId");

                    b.HasOne("Model.Director.Room", null)
                        .WithMany("Equipment_inventory")
                        .HasForeignKey("RoomId");
                });
